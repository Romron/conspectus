...
Типы вёрстки (реализация описана в файле css.txt)
	...
	Отзывчивый (резиновая вёрстка)
		описание:
			плавное, пропорциональное, изменение размеров при изменении размеров монитора
			при этом:
				внешний вид страницы 
					остаёться корректным
					соответствует дизайну макета
...
МетодологИИ вёрстки
	...
	FUN
	DoCSSa
Критерии вёрстки			https://www.100up.ru/testirovanie-html-verstki/#section-1	!!!!!!!!!!!!!!!!!!
	1. соответствие макету
		максимальное соответствие web страницы макету и тех заданию 
			нормальным счмтается точность +- 5px
	2. крос браузерность 
			максимальное соответствие web страницы макету и тех заданию 
	...
	4. валидность кода
		сервисы валидаторов
	5. независимасть блоков
		каскад css правил для блока должен быть минимальным
		в панели разработчика браузера в вкладке стили	
			перечёркнутых блоков должно быть как можно меньше
		пути достежения:
			использовать БЭМ
	6. удобство
		зона ответственности дезайнера
	7. скорость
		проверка на спецыализированных сайтах
		оптимизация вёрстки
			минимизация файлов
		...
		достигается системами автоматической зборки
			...
			webpack
			и т.д. 
	8. семантика и доступность
			пригодность для
				машинного анализа
					поисковых и прочих роботов
	...
	9. маштабируемость вёрстки ??
	10. структура каталогов вёрстки  ??
Ресурсы для проверки качества вёрстки:
	Внешние соответствие шаблону
		плагин для PerfectPixel by WellDoneCode (pixel perfect) Хрома !!!
	Комплексная проверка технических параметров сайта		
		lighthouse в браузере Хром
			находится в панели разработчика браузера
	Валидаторы 
		HTML
			https://validator.w3.org/	
		CSS
			https://jigsaw.w3.org/css-validator/   
	Адаптивность 		для проверки сайт должен быть доступен в нете
		https://search.google.com/test/mobile-friendly
		https://bluetree.ai/screenfly/
		http://iloveadaptive.com/ru/
	Кроссбраузерность
...
обязательно для страниц 
	недопустимо влаживать блачный элемент внутрь строчнаго
	необходимо заполнять атребут alt=""
	адекватность размеров самой страницы
		на странице не должно быть горозонтального скрола
	центровка блоков
		обязательно учитывать при адаптивах
	поля это очень важно!
		для надёжности
			отступы безопастности
		для восприятия страницы		
			поля между блоками	
			между контентной частью и границей экрана должны быть поля
				особенно на малых экранах	
	текст должен быть поверх изображения
	на элементах управления должен быть интерактив
		:hover
			transition
			animation
		на тачскринах :hover отсутствует
